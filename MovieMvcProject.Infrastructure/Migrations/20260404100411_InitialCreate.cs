        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieAvgReviewRate = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MovieReview = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PageType = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieVisitLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieVisitLogs_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "MovieId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieVisitLogs_MovieId",
                table: "MovieVisitLogs",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieVisitLogs_VisitedAt",
                table: "MovieVisitLogs",
                column: "VisitedAt");

            migrationBuilder.CreateIndex(
                name: "IX_MovieVisitLogs_VisitedAt_PageType",
                table: "MovieVisitLogs",
                columns: new[] { "VisitedAt", "PageType" });
